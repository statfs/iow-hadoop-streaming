...
package cn.sm.hadoop.streaming.parquet;
...
public class TextRecordWriterWrapper<K, V> implements RecordWriter<K, V> {
    ...
    private static String fieldSeperator = "\0x01";
    private static final String fieldSeperatorKey = "record.field.seperator";
    ...
    TextRecordWriterWrapper(ParquetRecordWriter<V> w, FileSystem fs, JobConf conf, String name, Progressable progress)
        ...
        //UPO
        fieldSeperator = conf.get(fieldSeperatorKey, TAB);
        realWriter = w;
    ...
    public void write(K key, V value) throws IOException {
        ...
        String[] strK = key.toString().split(fieldSeperator, -1);
        String[] strV = value.toString().split(fieldSeperator, -1);
